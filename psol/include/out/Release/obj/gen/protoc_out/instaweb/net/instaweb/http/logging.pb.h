...
class TimingInfo : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_time_to_start_processing_ms() const;
  inline void clear_time_to_start_processing_ms();
  static const int kTimeToStartProcessingMsFieldNumber = 10;
  inline ::google::protobuf::int64 time_to_start_processing_ms() const;
  inline void set_time_to_start_processing_ms(::google::protobuf::int64 value);
  
  // optional int64 time_to_pcache_lookup_start_ms = 11;
  inline bool has_time_to_pcache_lookup_start_ms() const;
  inline void clear_time_to_pcache_lookup_start_ms();
  static const int kTimeToPcacheLookupStartMsFieldNumber = 11;
  inline ::google::protobuf::int64 time_to_pcache_lookup_start_ms() const;
  inline void set_time_to_pcache_lookup_start_ms(::google::protobuf::int64 value);
  
  // optional int64 time_to_pcache_lookup_end_ms = 12;
  inline bool has_time_to_pcache_lookup_end_ms() const;
  inline void clear_time_to_pcache_lookup_end_ms();
  static const int kTimeToPcacheLookupEndMsFieldNumber = 12;
  inline ::google::protobuf::int64 time_to_pcache_lookup_end_ms() const;
  inline void set_time_to_pcache_lookup_end_ms(::google::protobuf::int64 value);
...
class CacheHtmlLoggingInfo : public ::google::protobuf::MessageLite {
 public:
  ...
  static const CacheHtmlRequestFlow CACHE_HTML_BLACKLISTED = CacheHtmlLoggingInfo_CacheHtmlRequestFlow_CACHE_HTML_BLACKLISTED;
  ...
  static const UserAgent NOT_SET = CacheHtmlLoggingInfo_UserAgent_NOT_SET;
  static const UserAgent CACHE_HTML_DESKTOP_WHITELIST = CacheHtmlLoggingInfo_UserAgent_CACHE_HTML_DESKTOP_WHITELIST;
  static const UserAgent CACHE_HTML_DESKTOP_BLACKLIST = CacheHtmlLoggingInfo_UserAgent_CACHE_HTML_DESKTOP_BLACKLIST;
  static const UserAgent CACHE_HTML_MOBILE = CacheHtmlLoggingInfo_UserAgent_CACHE_HTML_MOBILE;
  static const UserAgent NULL_OR_EMPTY = CacheHtmlLoggingInfo_UserAgent_NULL_OR_EMPTY;
  static const UserAgent NOT_SUPPORT_CACHE_HTML = CacheHtmlLoggingInfo_UserAgent_NOT_SUPPORT_CACHE_HTML;
  static inline bool UserAgent_IsValid(int value) {
  ...
  inline bool has_cache_html_user_agent() const;
  inline void clear_cache_html_user_agent();
  static const int kCacheHtmlUserAgentFieldNumber = 6;
  inline ::net_instaweb::CacheHtmlLoggingInfo_UserAgent cache_html_user_agent() const;
  inline void set_cache_html_user_agent(::net_instaweb::CacheHtmlLoggingInfo_UserAgent value);
...
class ImageRewriteResourceInfo : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_original_height() const;
  inline void clear_original_height();
  static const int kOriginalHeightFieldNumber = 6;
  inline ::google::protobuf::int32 original_height() const;
  inline void set_original_height(::google::protobuf::int32 value);
  
  // optional int32 original_width = 7 [default = 0];
  inline bool has_original_width() const;
  inline void clear_original_width();
  static const int kOriginalWidthFieldNumber = 7;
  inline ::google::protobuf::int32 original_width() const;
  inline void set_original_width(::google::protobuf::int32 value);
  
  // optional bool is_resized_using_rendered_dimensions = 8 [default = false];
  inline bool has_is_resized_using_rendered_dimensions() const;
  inline void clear_is_resized_using_rendered_dimensions();
  static const int kIsResizedUsingRenderedDimensionsFieldNumber = 8;
  inline bool is_resized_using_rendered_dimensions() const;
  inline void set_is_resized_using_rendered_dimensions(bool value);
  
  // optional int32 resized_height = 9 [default = 0];
  inline bool has_resized_height() const;
  inline void clear_resized_height();
  static const int kResizedHeightFieldNumber = 9;
  inline ::google::protobuf::int32 resized_height() const;
  inline void set_resized_height(::google::protobuf::int32 value);
...
class LoggingInfo : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_experiment_id() const;
  inline void clear_experiment_id();
  static const int kExperimentIdFieldNumber = 6;
  inline ::google::protobuf::int32 experiment_id() const;
  inline void set_experiment_id(::google::protobuf::int32 value);
  ...
  inline bool has_is_xhr() const;
  inline void clear_is_xhr();
  static const int kIsXhrFieldNumber = 25;
  inline bool is_xhr() const;
  inline void set_is_xhr(bool value);
  
  // optional .net_instaweb.TimingInfo deprecated_timing_info = 1;
  inline bool has_deprecated_timing_info() const;
  inline void clear_deprecated_timing_info();
  static const int kDeprecatedTimingInfoFieldNumber = 1;
  inline const ::net_instaweb::TimingInfo& deprecated_timing_info() const;
  inline ::net_instaweb::TimingInfo* mutable_deprecated_timing_info();
  inline ::net_instaweb::TimingInfo* release_deprecated_timing_info();
 ...
 private:
  ...
  inline void set_has_deprecated_timing_info();
  inline void clear_has_deprecated_timing_info();
  ...
  ::net_instaweb::TimingInfo* deprecated_timing_info_;
...
inline void CacheHtmlLoggingInfo::set_cache_html_user_agent(::net_instaweb::CacheHtmlLoggingInfo_UserAgent value) {
  GOOGLE_DCHECK(::net_instaweb::CacheHtmlLoggingInfo_UserAgent_IsValid(value));
...
// optional .net_instaweb.TimingInfo deprecated_timing_info = 1;
inline bool LoggingInfo::has_deprecated_timing_info() const {
  return (_has_bits_[0] & 0x01000000u) != 0;
}
inline void LoggingInfo::set_has_deprecated_timing_info() {
  _has_bits_[0] |= 0x01000000u;
}
inline void LoggingInfo::clear_has_deprecated_timing_info() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void LoggingInfo::clear_deprecated_timing_info() {
  if (deprecated_timing_info_ != NULL) deprecated_timing_info_->::net_instaweb::TimingInfo::Clear();
  clear_has_deprecated_timing_info();
}
inline const ::net_instaweb::TimingInfo& LoggingInfo::deprecated_timing_info() const {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return deprecated_timing_info_ != NULL ? *deprecated_timing_info_ : *default_instance().deprecated_timing_info_;
#else
  return deprecated_timing_info_ != NULL ? *deprecated_timing_info_ : *default_instance_->deprecated_timing_info_;
#endif
}
inline ::net_instaweb::TimingInfo* LoggingInfo::mutable_deprecated_timing_info() {
  set_has_deprecated_timing_info();
  if (deprecated_timing_info_ == NULL) deprecated_timing_info_ = new ::net_instaweb::TimingInfo;
  return deprecated_timing_info_;
}
inline ::net_instaweb::TimingInfo* LoggingInfo::release_deprecated_timing_info() {
  clear_has_deprecated_timing_info();
  ::net_instaweb::TimingInfo* temp = deprecated_timing_info_;
  deprecated_timing_info_ = NULL;
  return temp;
}
