...
class HttpResponseHeaders : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_browser_cacheable() const;
  inline void clear_browser_cacheable();
  static const int kBrowserCacheableFieldNumber = 7;
  inline bool browser_cacheable() const;
  inline void set_browser_cacheable(bool value);
  ...
  inline bool has_requires_browser_revalidation() const;
  inline void clear_requires_browser_revalidation();
  static const int kRequiresBrowserRevalidationFieldNumber = 13;
  inline bool requires_browser_revalidation() const;
  inline void set_requires_browser_revalidation(bool value);
  
  // optional bool requires_proxy_revalidation = 14;
  inline bool has_requires_proxy_revalidation() const;
  inline void clear_requires_proxy_revalidation();
  static const int kRequiresProxyRevalidationFieldNumber = 14;
  inline bool requires_proxy_revalidation() const;
  inline void set_requires_proxy_revalidation(bool value);
...
class HttpRequestHeaders : public ::google::protobuf::MessageLite {
 public:
  ...
  static const Method PURGE = HttpRequestHeaders_Method_PURGE;
